...
async def scrape_prnewswire(url: str) -> Optional[Dict[str, Any]]:
...
#     test_url = "https://www.prnewswire.com/news-releases/emersons-new-engineering-software-accelerates-plant-modernization-using-artificial-intelligence-301910424.html"

#     async def _main():
#         result = await scrape_prnewswire(test_url)
#         if result:
#             print("\n" + "=" * 80)
